...
export const views: Record<LastLevelRouteKey, RouteComponent | (() => Promise<RouteComponent>)> = {
  ...
  manufacture_line: () => import("@/views/manufacture/line/index.vue"),
  manufacture_product: () => import("@/views/manufacture/product/index.vue"),
  manufacture_station: () => import("@/views/manufacture/station/index.vue"),
